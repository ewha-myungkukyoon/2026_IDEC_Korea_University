 ...
 *       Filename:  main.cu
 *
 *    Description:  Full GPU inference for the simple CIFAR-10 CNN:
 *                  Input(3,32,32) -> Conv1 -> ReLU -> MaxPool -> FC1 ->
 *                  10 class logits. Loads pre-trained weights and reports
 *                  Top-1 accuracy and per-layer timing on the CIFAR-10
 *                  test set.
 *
 *        Version:  1.0
