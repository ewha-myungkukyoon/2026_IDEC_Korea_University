 ...
 *       Filename:  main.cu
 *
 *    Description:  Exercise: implement Conv1 via explicit lowering (im2col
 *                  + a plain GEMM) instead of direct convolution, then
 *                  port the rest of the BATCHED CIFAR-10 CNN inference.
 *                  Compare Conv1's timing against 04's direct convolution.
